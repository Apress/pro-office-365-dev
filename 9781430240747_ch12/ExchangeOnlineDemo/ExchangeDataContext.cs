...
namespace ExchangeOnlineDemo
{
    public class ExchangeDataContext
    {
        ...
        public GetUserAvailabilityResults GetAvailability(string organizer, List<string> requiredAttendees, int meetingDuration, int timeWindowDays)
        {
            ...
            GetUserAvailabilityResults results = _service.GetUserAvailability(attendees, 
